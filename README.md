...
This is a solid app that does a great job using redux and reducers. It needs a readme file to help with installation and it needs to do an axios post on submit. But the routing and the redux store are really tight.
...
| Commits are descriptive of the changes made or feature added | ish |
...
What you did here you did really well! Bringing the database into the app would really bring the whole thing together, but ths is a good design and really good execution of what you wrote.  
